...
class PWAInstallManager {
  ...
  showNotification(message, type = 'info') {
    ...
    notification.className = `pwa-notification fixed top-6 left-1/2 transform -translate-x-1/2 px-6 py-3 rounded-lg shadow-xl z-50 text-white ${type === 'success' ? 'bg-green-500' :
